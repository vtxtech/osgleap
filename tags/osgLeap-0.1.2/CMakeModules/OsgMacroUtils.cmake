...
MACRO(SETUP_LIBRARY LIB_NAME)
    ...
    ELSE()
        ...
        ADD_LIBRARY(${LIB_NAME}
            ${OSGLEAP_USER_DEFINED_DYNAMIC_OR_STATIC}
            ${TARGET_H}
...
MACRO(SETUP_EXAMPLE EXAMPLE_NAME)
        ...
        IF(APPLE)
            INSTALL(TARGETS ${TARGET_TARGETNAME} RUNTIME DESTINATION ${OSGLEAP_EXAMPLES_INSTALLDIR} BUNDLE DESTINATION ${OSGLEAP_EXAMPLES_INSTALLDIR} )            
        ELSE(APPLE)
            INSTALL(TARGETS ${TARGET_TARGETNAME} RUNTIME DESTINATION ${OSGLEAP_EXAMPLES_INSTALLDIR} COMPONENT osgleap-examples )
        ENDIF(APPLE)
